...
insert into STUDENTS VALUES(1,'meet','city light','Tejash sir',1,'mca2',1,2,'M');
insert into STUDENTS VALUES(2,'karan','Undhana road','Shashi sir',2,'mca2',2,2,'M');
insert into STUDENTS VALUES(3,'jay','city light','neha mam',3,'mca2',3,2,'M');
insert into STUDENTS VALUES(4,'sami','Undhana road','khusbhoo mam',2,'mca2',4,2,'F');
insert into STUDENTS VALUES(5,'kunal','city light','Tejash sir',3,'mca2',5,2,'M');
UPDATE STUDENTS set gender='M' where sid=1;
...
BEGIN
        SELECT COUNT(*) into TOTAL_M from STUDENTS where gender='M';
        SELECT COUNT(*) into TOTAL_F from STUDENTS where gender='F';

        dbms_output.put_line('Male:'||TOTAL_M);
        dbms_output.put_line('Female:'||TOTAL_F);
END;        
/